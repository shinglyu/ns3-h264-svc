...
*/
class UdpH264TraceClientHelper
{
public:
  /**
   * Create UdpH264TraceClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
   */
  UdpH264TraceClientHelper ();
   ...
   */
  UdpH264TraceClientHelper (Address ip, uint16_t port, std::string filename);
  UdpH264TraceClientHelper (Ipv4Address ip, uint16_t port, std::string filename);
  UdpH264TraceClientHelper (Ipv6Address ip, uint16_t port, std::string filename);
